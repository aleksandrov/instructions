...
4. CLAUDE.md should have high level functionality explanation only.
5. Git history of CLAUDE.md and TODO.md shoud help to understand how requirements evolved over time.
